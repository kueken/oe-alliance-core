...
RRECOMMENDS_${PN} = " \
    ...
    ${@bb.utils.contains("DEFAULTTUNE", "sh4", "" , "enigma2-plugin-systemplugins-icetv", d)} \
    enigma2-plugin-extensions-mediaplayer \
    ${@bb.utils.contains("MACHINE_FEATURES", "smallflash", "", "enigma2-plugin-extensions-openwebif-terminal", d)} \
    ${@bb.utils.contains_any("MACHINE_FEATURES", "smallflash kernel26", "", "enigma2-plugin-extensions-enhancedmoviecenter", d)} \
    ...
    ${@bb.utils.contains_any("MACHINE_FEATURES", "dvbc-only kernel26", "", "enigma2-plugin-extensions-programmlistenupdater", d)} \
